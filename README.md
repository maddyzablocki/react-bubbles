...
A token is encrypted code needed to gain access to data
- [ ] What steps can you take in your web apps to keep your data secure?
You can set up your backend to require a token to obtain data, and you can use protected routes and redirect in your front end 
- [ ] Describe how web servers work.
A user will enter in the URL, it then goes to the moedum, then to the lcoal internet access provider, then it finds what server the website is hosted on.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
C= create(post), R=read(get), U=updated(put), D=delete(...delete)
...
- [x (form is having weird issues, and randomly deleting text though)] Build a form at the bottom of `ColorList.js` to add new colors to the colors data
